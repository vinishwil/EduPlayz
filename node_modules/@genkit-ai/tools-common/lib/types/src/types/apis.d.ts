...
export declare const StreamTraceRequestSchema: z.ZodObject<{
    traceId: z.ZodString;
}, "strip", z.ZodTypeAny, {
    traceId: string;
}, {
...
export declare const CancelActionRequestSchema: z.ZodObject<{
    traceId: z.ZodString;
    runtimeId: z.ZodOptional<z.ZodString>;
}, "strip", z.ZodTypeAny, {
    traceId: string;
...
export declare const CreateDatasetRequestSchema: z.ZodObject<{
    ...
    datasetId: z.ZodOptional<z.ZodString>;
    datasetType: z.ZodEnum<["UNKNOWN", "FLOW", "MODEL", "EXECUTABLE_PROMPT"]>;
