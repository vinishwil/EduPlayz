...
export declare const TOOLS_SERVER_ROUTER: (manager: RuntimeManager) => import("@trpc/server").CreateRouterInner<import("@trpc/server").RootConfig<{
    ...
    addTrace: import("@trpc/server").BuildProcedure<"mutation", {
        _config: import("@trpc/server").RootConfig<{
            ctx: object;
            meta: object;
            errorShape: import("@trpc/server").DefaultErrorShape | {
    ...
    listDatasets: import("@trpc/server").BuildProcedure<"query", {
        ...
        _output_in: {
            ...
            datasetId: string;
            size: number;
            datasetType: "UNKNOWN" | "FLOW" | "MODEL" | "EXECUTABLE_PROMPT";
            createTime: string;
            updateTime: string;
            schema?: {
    ...
    getAppProcessStatus: import("@trpc/server").BuildProcedure<"query", {
        _config: import("@trpc/server").RootConfig<{
            ctx: object;
            meta: object;
            errorShape: import("@trpc/server").DefaultErrorShape | {
    ...
    restartAppProcess: import("@trpc/server").BuildProcedure<"query", {
        _config: import("@trpc/server").RootConfig<{
            ctx: object;
            meta: object;
            errorShape: import("@trpc/server").DefaultErrorShape | {
    ...
    killAppProcess: import("@trpc/server").BuildProcedure<"query", {
        _config: import("@trpc/server").RootConfig<{
            ctx: object;
            meta: object;
            errorShape: import("@trpc/server").DefaultErrorShape | {
    ...
    cancelAction: import("@trpc/server").BuildProcedure<"mutation", {
        _config: import("@trpc/server").RootConfig<{
            ctx: object;
            meta: object;
            errorShape: import("@trpc/server").DefaultErrorShape | {
