...
exports.StreamTraceRequestSchema = zod_1.z.object({
    traceId: zod_1.z.string().describe('ID of the trace to stream.'),
});
...
exports.CancelActionRequestSchema = zod_1.z.object({
    traceId: zod_1.z
        .string()
