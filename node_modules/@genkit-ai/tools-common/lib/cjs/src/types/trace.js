...
exports.NestedSpanDataSchema = exports.TraceEventSchema = exports.SpanEndEventSchema = exports.SpanStartEventSchema = exports.SpantEventBaseSchema = exports.TraceDataSchema = exports.SpanDataSchema = exports.InstrumentationLibrarySchema = exports.LinkSchema = exports.SpanContextSchema = exports.TimeEventSchema = exports.SpanStatusSchema = exports.SpanMetadataSchema = exports.TraceMetadataSchema = exports.PathMetadataSchema = void 0;
...
exports.TraceDataSchema = z
    ...
    .openapi('TraceData');
exports.SpantEventBaseSchema = z.object({
    traceId: z.string(),
    span: exports.SpanDataSchema,
});
exports.SpanStartEventSchema = exports.SpantEventBaseSchema.extend({
    type: z.literal('span_start'),
});
exports.SpanEndEventSchema = exports.SpantEventBaseSchema.extend({
    type: z.literal('span_end'),
});
exports.TraceEventSchema = z.union([
    exports.SpanStartEventSchema,
    exports.SpanEndEventSchema,
]);
