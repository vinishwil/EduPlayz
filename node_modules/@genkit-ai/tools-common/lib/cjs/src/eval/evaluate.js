...
async function runEvaluation(params) {
    ...
    for (const action of evaluatorActions) {
        ...
        utils_1.logger.info(`Finished evaluator '${action.name}'. Trace ID: ${response.telemetry?.traceId}`);
    }
...
async function runPromptAction(params) {
    ...
    try {
        ...
        renderedPrompt = {
            ...
            result: types_1.GenerateActionOptionsSchema.parse(runActionResponse.result),
        };
    }
    catch (e) {
...
async function gatherEvalInput(params) {
    ...
    if (traceIds.length === 0 ||
        ...
        utils_1.logger.warn('No valid traceId available...');
        return {
            ...state,
