import { z, JSONSchema7, ActionContext, Action, ActionRunOptions, ActionFnArg, StreamingCallback, GenkitError, Operation } from '@genkit-ai/core';
import { Registry } from '@genkit-ai/core/registry';
import { b as DocumentData } from './document-CU5Javl9.js';
import { GenerateResponseChunk } from './generate/chunk.js';
import { GenerateResponse } from './generate/response.js';
import { M as ModelArgument, c as ModelMiddleware, d as ModelMiddlewareArgument } from './model-ClfD23k3.js';
import { ResourceArgument } from './resource.js';
import { Part, MessageData, GenerateRequestSchema, GenerateResponseSchema, GenerateResponseChunkSchema, ToolDefinition, GenerationCommonConfigSchema, GenerateRequest, GenerateResponseData, GenerateActionOptions } from './model-types.js';
import { ToolRequestPart, ToolResponsePart, MultipartToolResponseSchema } from './parts.js';
 ...
 */
type MultipartToolAction<I extends z.ZodTypeAny = z.ZodTypeAny, O extends z.ZodTypeAny = z.ZodTypeAny> = Action<I, typeof MultipartToolResponseSchema, z.ZodTypeAny, ToolRunOptions> & Resumable<I, O> & {
    __action: {
        metadata: {
            type: 'tool.v2';
        };
...
type MultipartToolFn<I extends z.ZodTypeAny, O extends z.ZodTypeAny> = (input: z.infer<I>, ctx: ToolFnOptions & ToolRunOptions) => Promise<{
    output?: z.infer<O>;
    content?: Part[];
}>;
declare function defineTool<I extends z.ZodTypeAny, O extends z.ZodTypeAny>(registry: Registry, config: {
    multipart: true;
} & ToolConfig<I, O>, fn?: ToolFn<I, O>): MultipartToolAction<I, O>;
...
declare function interrupt<I extends z.ZodTypeAny, O extends z.ZodTypeAny>(config: InterruptConfig<I, O>): ToolAction<I, O>;
...
declare function tool<I extends z.ZodTypeAny, O extends z.ZodTypeAny>(config: {
    multipart: true;
} & ToolConfig<I, O>, fn?: ToolFn<I, O>): MultipartToolAction<I, O>;
...
export { toGenerateActionOptions as $, isPromptAction as A, type ExecutablePromptAction as B, type PartsResolver as C, type DocsResolver as D, type ExecutablePrompt as E, loadPromptFolderRecursively as F, GenerationBlockedError as G, type Resumable as H, type InterruptConfig as I, type MultipartToolAction as J, type DynamicToolAction as K, resolveTools as L, type MessagesResolver as M, lookupToolByName as N, type OutputOptions as O, type PromptAction as P, toToolDefinition as Q, type ResumeOptions as R, type ToolFnOptions as S, type ToolChoice as T, type ToolFn as U, type MultipartToolFn as V, isToolRequest as W, isToolResponse as X, isDynamicTool as Y, tool as Z, dynamicTool as _, GenerationResponseError as a, generateOperation as b, generateStream as c, toGenerateRequest as d, type GenerateOptions as e, type GenerateStreamOptions as f, generate as g, type GenerateStreamResponse as h, defineHelper as i, definePartial as j, definePrompt as k, isExecutablePrompt as l, loadPromptFolder as m, type PromptConfig as n, type PromptGenerateOptions as o, prompt as p, ToolInterruptError as q, asTool as r, defineInterrupt as s, tagAsPreamble as t, defineTool as u, interrupt as v, type ToolAction as w, type ToolArgument as x, type ToolConfig as y, type ToolRunOptions as z };
