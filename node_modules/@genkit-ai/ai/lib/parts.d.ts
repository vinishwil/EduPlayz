 ...
 */
declare const ToolResponseSchemaBase: z.ZodObject<{
    /** The call id or reference for a specific request. */
    ref: z.ZodOptional<z.ZodString>;
 ...
 * Tool response part.
 */
type ToolResponse = z.infer<typeof ToolResponseSchemaBase> & {
    content?: Part[];
};
declare const ToolResponseSchema: z.ZodType<ToolResponse>;
/**
...
declare const MultipartToolResponseSchema: z.ZodObject<{
    output: z.ZodOptional<z.ZodUnknown>;
...
type MultipartToolResponse = z.infer<typeof MultipartToolResponseSchema>;
