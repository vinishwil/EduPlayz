...
import { FunctionDeclaration, Content, FunctionCallingMode, PartialArg, GenerateContentCandidate } from './types.mjs';
 ...
 */
declare function applyGeminiPartialArgs(target: object, partialArgs: PartialArg[]): void;
declare function fromGeminiCandidate(candidate: GenerateContentCandidate, previousChunks?: CandidateData[]): CandidateData;

export { applyGeminiPartialArgs, fromGeminiCandidate, toGeminiFunctionModeEnum, toGeminiMessage, toGeminiSystemInstruction, toGeminiTool };
