import { ModelReference, z, EmbedderReference, MediaPart, JSONSchema } from 'genkit';
import { GenerateRequest } from 'genkit/model';
import { GenerateContentStreamResult, GenerateContentResponse } from './types.js';
 ...
 */
declare function stringTruncator(key: string, value: unknown): unknown;
/**
 ...
 * @returns
 */
declare function extractMediaArray(request: GenerateRequest, params: {
    metadataType?: string;
    isDefault?: boolean;
}): MediaPart[] | undefined;
/**
...
declare function aggregateResponses(responses: GenerateContentResponse[]): GenerateContentResponse;
declare function getGenkitClientHeader(): string;
declare const TEST_ONLY: {
    aggregateResponses: typeof aggregateResponses;
};

export { TEST_ONLY, checkModelName, checkSupportedMimeType, cleanSchema, displayUrl, extractErrMsg, extractMedia, extractMediaArray, extractMimeType, extractText, extractVersion, getGenkitClientHeader, modelName, processStream, stringTruncator };
