 ...
 */
declare function listModels(apiKey: string | undefined, clientOptions?: ClientOptions): Promise<Model[]>;
/**
 ...
 */
declare function generateContent(apiKey: string | undefined, model: string, generateContentRequest: GenerateContentRequest, clientOptions?: ClientOptions): Promise<GenerateContentResponse>;
/**
 ...
 */
declare function generateContentStream(apiKey: string | undefined, model: string, generateContentRequest: GenerateContentRequest, clientOptions?: ClientOptions): Promise<GenerateContentStreamResult>;
/**
 ...
 * @throws {Error} If the API request fails or the response cannot be parsed.
 */
declare function embedContent(apiKey: string | undefined, model: string, embedContentRequest: EmbedContentRequest, clientOptions?: ClientOptions): Promise<EmbedContentResponse>;
declare function imagenPredict(apiKey: string | undefined, model: string, imagenPredictRequest: ImagenPredictRequest, clientOptions?: ClientOptions): Promise<ImagenPredictResponse>;
declare function veoPredict(apiKey: string | undefined, model: string, veoPredictRequest: VeoPredictRequest, clientOptions?: ClientOptions): Promise<VeoOperation>;
declare function veoCheckOperation(apiKey: string | undefined, operation: string, clientOptions?: ClientOptions): Promise<VeoOperation>;
/**
