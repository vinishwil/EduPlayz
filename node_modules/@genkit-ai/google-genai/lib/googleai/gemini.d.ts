...
declare const GeminiConfigSchema: z.ZodObject<{
    ...
    fileSearch: z.ZodOptional<z.ZodObject<{
        fileSearchStoreNames: z.ZodArray<z.ZodString, "many">;
    ...
    urlContext: z.ZodOptional<z.ZodUnion<[z.ZodBoolean, z.ZodObject<{}, "passthrough", z.ZodTypeAny, z.objectOutputType<{}, z.ZodTypeAny, "passthrough">, z.objectInputType<{}, z.ZodTypeAny, "passthrough">>]>>;
...
type ConfigSchemaType = GeminiConfigSchemaType | GeminiTtsConfigSchemaType | GeminiImageConfigSchemaType | GemmaConfigSchemaType;
...
declare const KNOWN_IMAGE_MODELS: {
    ...
    readonly 'gemini-2.5-flash-image-preview': ModelReference<ConfigSchemaType>;
...
declare function listKnownModels(options?: GoogleAIPluginOptions): ModelAction<z.ZodTypeAny>[];
/**
 * Defines a new GoogleAI Gemini model.
 */
declare function defineModel(name: string, pluginOptions?: GoogleAIPluginOptions): ModelAction;
