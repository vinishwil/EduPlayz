import { Content, TaskType } from '../common/types.mjs';
...
export { type ClientOptions, Content, type ContentEmbedding, type EmbedContentRequest, type EmbedContentResponse, type GoogleAIPluginOptions, type ListModelsResponse, type Model, type VeoImage, type VeoInstance, type VeoOperation, type VeoParameters, type VeoPredictRequest, type VeoVideo };
