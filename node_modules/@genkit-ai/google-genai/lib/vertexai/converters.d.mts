...
import { SafetySetting, ImagenPredictRequest, ImagenPredictResponse } from '../common/types.mjs';
import { SafetySettingsSchema } from './gemini.mjs';
import { ImagenConfigSchemaType } from './imagen.mjs';
import { LyriaConfigSchemaType } from './lyria.mjs';
import { LyriaPredictRequest, LyriaPredictResponse, VeoPredictRequest, VeoMedia, VeoOperation, VeoOperationRequest, ClientOptions } from './types.mjs';
import { VeoConfigSchemaType } from './veo.mjs';
import 'genkit/model';
...
declare function toVeoClientOptions(op: Operation<GenerateResponseData>, clientOpt: ClientOptions): ClientOptions;

export { fromImagenResponse, fromLyriaResponse, fromVeoOperation, toGeminiLabels, toGeminiSafetySettings, toImagenPredictRequest, toLyriaPredictRequest, toVeoClientOptions, toVeoMedia, toVeoModel, toVeoOperationRequest, toVeoPredictRequest };
