...
export { checkModelName, checkSupportedMimeType, cleanSchema, extractMedia, extractMimeType, extractText, extractVersion, modelName } from '../common/utils.js';
...
type RequestClientOptions = ClientOptions & {
    signal: AbortSignal;
};
/**
 ...
 */
declare function calculateRequestOptions<T extends z.ZodObject<any, any, any>>(clientOptions: RequestClientOptions, reqConfig?: z.infer<T>): RequestClientOptions;
...
export { API_KEY_FALSE_ERROR, MISSING_API_KEY_ERROR, NOT_SUPPORTED_IN_EXPRESS_ERROR, type RequestClientOptions, TEST_ONLY, calculateApiKey, calculateRequestOptions, checkApiKey, checkSupportedResourceMethod, getApiKeyFromEnvVar, getDerivedOptions };
