...
import { KnownImageModels, ImageModelName, GeminiImageConfig, GeminiImageConfigSchemaType, KnownGeminiModels, GeminiModelName, GeminiConfig, GeminiConfigSchemaType } from './gemini.mjs';
import { KnownModels, ImagenModelName, ImagenConfig, ImagenConfigSchemaType } from './imagen.mjs';
import { KnownModels as KnownModels$1, LyriaModelName, LyriaConfig, LyriaConfigSchemaType } from './lyria.mjs';
import { KnownModels as KnownModels$2, VeoModelName, VeoConfig, VeoConfigSchemaType } from './veo.mjs';
...
type VertexAIPlugin = {
    ...
    model(name: KnownImageModels | (ImageModelName & {}), config?: GeminiImageConfig): ModelReference<GeminiImageConfigSchemaType>;
    ...
    model(name: KnownModels$1 | (LyriaModelName & {}), config: LyriaConfig): ModelReference<LyriaConfigSchemaType>;
    model(name: KnownModels$2 | (VeoModelName & {}), config: VeoConfig): ModelReference<VeoConfigSchemaType>;
