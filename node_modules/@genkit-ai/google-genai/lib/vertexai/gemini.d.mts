...
declare const GeminiConfigSchema: z.ZodObject<{
    ...
    functionCallingConfig: z.ZodOptional<z.ZodObject<{
         ...
         */
        streamFunctionCallArguments: z.ZodOptional<z.ZodBoolean>;
    }, "passthrough", z.ZodTypeAny, z.objectOutputType<{
        mode: z.ZodOptional<z.ZodEnum<["MODE_UNSPECIFIED", "AUTO", "ANY", "NONE"]>>;
        allowedFunctionNames: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
        /**
...
declare const GeminiImageConfigSchema: z.ZodObject<{
    version: z.ZodOptional<z.ZodString>;
    maxOutputTokens: z.ZodOptional<z.ZodNumber>;
    topK: z.ZodOptional<z.ZodNumber>;
    stopSequences: z.ZodOptional<z.ZodArray<z.ZodString, "many">>;
    ...
    imageConfig: z.ZodOptional<z.ZodObject<{
        aspectRatio: z.ZodOptional<z.ZodEnum<["1:1", "2:3", "3:2", "3:4", "4:3", "4:5", "5:4", "9:16", "16:9", "21:9"]>>;
        imageSize: z.ZodOptional<z.ZodEnum<["1K", "2K", "4K"]>>;
    }, "passthrough", z.ZodTypeAny, z.objectOutputType<{
        aspectRatio: z.ZodOptional<z.ZodEnum<["1:1", "2:3", "3:2", "3:4", "4:3", "4:5", "5:4", "9:16", "16:9", "21:9"]>>;
        imageSize: z.ZodOptional<z.ZodEnum<["1K", "2K", "4K"]>>;
    }, z.ZodTypeAny, "passthrough">, z.objectInputType<{
...
type GeminiImageConfigSchemaType = typeof GeminiImageConfigSchema;
type GeminiImageConfig = z.infer<GeminiImageConfigSchemaType>;
...
declare const KNOWN_GEMINI_MODELS: {
    readonly 'gemini-3-pro-preview': ModelReference<ConfigSchemaType>;
    readonly 'gemini-2.5-flash-lite': ModelReference<ConfigSchemaType>;
    readonly 'gemini-2.5-pro': ModelReference<ConfigSchemaType>;
    readonly 'gemini-2.5-flash': ModelReference<ConfigSchemaType>;
    readonly 'gemini-2.0-flash-001': ModelReference<ConfigSchemaType>;
    readonly 'gemini-2.0-flash': ModelReference<ConfigSchemaType>;
    readonly 'gemini-2.0-flash-lite': ModelReference<ConfigSchemaType>;
    readonly 'gemini-2.0-flash-lite-001': ModelReference<ConfigSchemaType>;
};
...
declare const KNOWN_IMAGE_MODELS: {
    readonly 'gemini-3-pro-image-preview': ModelReference<ConfigSchemaType>;
    readonly 'gemini-2.5-flash-image': ModelReference<ConfigSchemaType>;
};
type KnownImageModels = keyof typeof KNOWN_IMAGE_MODELS;
type ImageModelName = `gemini-${string}-image${string}`;
declare function isImageModelName(value?: string): value is ImageModelName;
declare const KNOWN_MODELS: {
    'gemini-3-pro-image-preview': ModelReference<ConfigSchemaType>;
    'gemini-2.5-flash-image': ModelReference<ConfigSchemaType>;
    'gemini-3-pro-preview': ModelReference<ConfigSchemaType>;
    ...
    'gemini-2.0-flash-001': ModelReference<ConfigSchemaType>;
    'gemini-2.0-flash': ModelReference<ConfigSchemaType>;
    'gemini-2.0-flash-lite': ModelReference<ConfigSchemaType>;
    'gemini-2.0-flash-lite-001': ModelReference<ConfigSchemaType>;
};
type KnownModels = keyof typeof KNOWN_MODELS;
declare function model(version: string, config?: ConfigSchema): ModelReference<ConfigSchemaType>;
