...
export { ATTR_PREFIX, SPAN_TYPE_ATTR, appendSpan, disableOTelRootSpanDetection, runInNewSpan, setCustomMetadataAttribute, setCustomMetadataAttributes, spanMetadataAlsKey, toDisplayPath } from './tracing/instrumentation.js';
 ...
 * @hidden
 */
declare function disableGenkitOTelInitialization(): void;

export { type TelemetryProvider, disableGenkitOTelInitialization, enableTelemetry, ensureBasicTelemetryInstrumentation, flushTracing, setTelemetryProvider };
