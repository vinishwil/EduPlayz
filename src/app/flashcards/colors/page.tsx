...
import { colorFlashcards } from '@/lib/flashcard-data';
import { PlaceHolderImages } from '@/lib/placeholder-images';
import { useSpeech } from '@/hooks/use-speech';
import { useEffect, useState } from 'react';
import { motion } from 'framer-motion';

export default function ColorFlashcardsPage() {
                      ...
                      <div className="perspective-1000" onClick={() => handleCardClick(item.name)}>
                        ...
                        >
                          ...
                          <div className="absolute w-full h-full backface-hidden rotate-y-180">
                            <Card className="h-full overflow-hidden shadow-2xl" style={{ backgroundColor: placeholder?.imageHint }}>
                              <CardContent className="flex items-center justify-center h-full p-6">
                                  <p className="text-5xl md:text-7xl font-bold text-white mix-blend-difference">
                                    {item.name}
                                  </p>
                              </CardContent>
                            </Card>
