...
class AsyncTaskQueue {
   ...
   */ enqueue(task) {
        if (this.options.stopOnError) {
            ...
            this.last = this.last.catch(()=>{}).then(()=>lazy(task)).then((res)=>res);
        }
        this.last.catch(()=>{});
    }
    /**
...
class TraceServerExporter {
   ...
   */ forceFlush() {
    ...
    async save(traceId, spans) {
        ...
        await import_api.context.with((0, import_core.suppressTracing)(import_api.context.active()), ()=>fetch(`${telemetryServerUrl}/api/traces`, {
                method: "POST",
                headers: {
...
function isOTelInitializationDisabled() {
    return /*TURBOPACK member replacement*/ __turbopack_context__.g[oTelInitializationKey] === true;
}
function disableGenkitOTelInitialization() {
    /*TURBOPACK member replacement*/ __turbopack_context__.g[oTelInitializationKey] = true;
}
// Annotate the CommonJS export names for ESM import in node:
0 && (module.exports = {
...
"[project]/node_modules/@genkit-ai/core/lib/streaming.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var import_tracing = __turbopack_context__.r("[project]/node_modules/@genkit-ai/core/lib/tracing.js [app-rsc] (ecmascript)");
var import_statusTypes = __turbopack_context__.r("[project]/node_modules/@genkit-ai/core/lib/statusTypes.js [app-rsc] (ecmascript)");
var import_streaming2 = __turbopack_context__.r("[project]/node_modules/@genkit-ai/core/lib/streaming.js [app-rsc] (ecmascript)");
...
var import_express = __toESM(__turbopack_context__.r("[externals]/express [external] (express, cjs, [project]/node_modules/express)"));
...
class ReflectionServer {
    ...
    /** Map of active actions indexed by trace ID for cancellation support. */ activeActions = /* @__PURE__ */ new Map();
...
"[project]/node_modules/@genkit-ai/core/lib/dynamic-action-provider.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
`, e);
        ...
        for (const [key, action] of Object.entries(await this.listActions())){
            ...
            if ((0, import_dynamic_action_provider.isDynamicActionProvider)(action)) {
                try {
                    const dapPrefix = `/${action.__action.actionType}/${action.__action.name}`;
                    const dapMetadataRecord = await action.getActionMetadataRecord(dapPrefix);
                    resolvableActions = {
                        ...resolvableActions,
                        ...dapMetadataRecord
                    };
                } catch (e) {
                    import_logging.logger.error(`Error listing actions for Dynamic Action Provider ${action.__action.name}`);
                }
            }
        }
        return {
...
"[project]/node_modules/@genkit-ai/core/lib/tracing/realtime-span-processor.js [app-rsc] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
var realtime_span_processor_exports = {};
__export(realtime_span_processor_exports, {
    RealtimeSpanProcessor: ()=>RealtimeSpanProcessor
});
module.exports = __toCommonJS(realtime_span_processor_exports);
...
}); //# sourceMappingURL=realtime-span-processor.js.map
}),
...
var import_realtime_span_processor = __turbopack_context__.r("[project]/node_modules/@genkit-ai/core/lib/tracing/realtime-span-processor.js [app-rsc] (ecmascript)");
...
//# sourceMappingURL=node_modules_%40genkit-ai_core_lib_923518f2._.js.map