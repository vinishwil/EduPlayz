...
"[project]/src/app/games/what-comes-after/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function WhatComesAfterGame() {
    _s();
    const [currentNumber, setCurrentNumber] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(1);
    ...
    const numberSequence = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "WhatComesAfterGame.useMemo[numberSequence]": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$numbers$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["numbers"].map({
                "WhatComesAfterGame.useMemo[numberSequence]": (n)=>n.number
            }["WhatComesAfterGame.useMemo[numberSequence]"]).filter({
                "WhatComesAfterGame.useMemo[numberSequence]": (n)=>n < 10
            }["WhatComesAfterGame.useMemo[numberSequence]"])
    }["WhatComesAfterGame.useMemo[numberSequence]"], []);
    const nextQuestion = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "WhatComesAfterGame.useCallback[nextQuestion]": ()=>{
            setLastClicked(null);
                        ...
                        setTimeout({
                            "WhatComesAfterGame.useCallback[nextQuestion]": ()=>{
                                ...
                                const newChoices = [
                                    ...
                                    "WhatComesAfterGame.useCallback[nextQuestion].newChoices": ()=>0.5 - Math.random()
                                }["WhatComesAfterGame.useCallback[nextQuestion].newChoices"]);
                                setChoices(newChoices);
                                setTimeout({
                                    "WhatComesAfterGame.useCallback[nextQuestion]": ()=>speak(`What comes after ${baseNumber}?`)
                                }["WhatComesAfterGame.useCallback[nextQuestion]"], 500);
                            }
                        }["WhatComesAfterGame.useCallback[nextQuestion]"], 100);
                    }
                }["WhatComesAfterGame.useCallback[nextQuestion]"], 4000);
                return;
            }
...
_s(WhatComesAfterGame, "TGxkjYDc5PYBImygYuPxCoV1T+8=", false, function() {
    return [
...
_c = WhatComesAfterGame;
var _c;
__turbopack_context__.k.register(_c, "WhatComesAfterGame");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_c7291c67._.js.map